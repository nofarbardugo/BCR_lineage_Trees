...
{
  return (switch(isotypeName, "IGHM"="blue", "IGHG-1"="#CC6666","IGHG-2"="brown", "IGHD"="#FF3399","IGHA" ="orange","naive_IGHM"="green","IGHE"="purple","black"))
}
...
############## main ###########################
#### this script create a pdf file with schematic isotype tree on it.
#### you can save all trees in on file or separate it into different files
###############################################
    ...
    if(file.exists(filePath))
    {
      ...
      if(!is.null(edges.df))
      {
        ...
        #  {      
          ...
          pdf(file =  paste0("/home/bardugn1/flu2/PlotNew/",patient.dirs[k],'/',dirs[i],"_",j,"_treeImage.pdf"))
            #jpeg(filename=  paste0("/home/bardugn1/flu2/PlotNew/",patient.dirs[k],'/',dirs[i],"_",j,"_treeImage.jpeg"),width = 1500, height = 900)
            #    jpeg(filename=  paste0(source.dir,"/plot/",patient.dirs[k],'/',dirs[i],"_",j,"_treeImage.jpeg"),width = 1400, height = 800)
