...
{
  return (switch(isotypeName, "igMplus"="blue", "igMminus"="red","plum2"))
}
      ...
      if(!is.null(edges.df))
      {
        ...
        while(j<=length(roots))
        {
          ...
          #  shape.edge = sapply(sameIsotype.vector,givEdgeShape)
            ...
            jpeg(filename=  paste0("/home/bardugn1/spleen/Plot/",patient.dirs[k],'/',dirs[i],"_",j,"_treeImage.jpeg"),width = 1500, height = 900)
