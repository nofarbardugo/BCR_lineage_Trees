...
df.dir <- 'flu2/Formatted/'
tree.dir <- 'flu2/fluHumanTree15oct2015/'
out.dir <- 'flu2/mut/'
    ...
    if(file.exists(filePath))
    {
      ...
      if(!is.null(trim.edge.df))
      {
        ...
        if(J<0)
        {
      	...
      	seq.len <- nchar(fasta.df[1,"seq"])-20 + Jseq.len
...
print(numberAll)
#save table
write.csv(res, paste0(out.dir, 'FLU_Combine_isotype_RS.csv'), row.names=F)  
#write.csv(res, paste0(out.dir, 'FLU_RS.csv'), row.names=F)   
print("finish")
