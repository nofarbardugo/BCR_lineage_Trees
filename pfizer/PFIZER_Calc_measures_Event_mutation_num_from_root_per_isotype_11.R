...
TOTAL.allIsotypeDetails[["IGHG"]] <- data.frame(Synonymus =c(),nonSynonymus =c(),depth = c(),Ratio = c(),
                                                synonyms_CDR= c(),synonyms_FR = c(),nonSynonyms_CDR = c(),
                                                nonSynonyms_FR = c())
...
TOTAL.allIsotypeDetails[["naive_IGHD"]] <- data.frame(Synonymus =c(),nonSynonymus =c(),depth = c(),Ratio = c(),
                                                      synonyms_CDR= c(),synonyms_FR = c(),nonSynonyms_CDR = c(),
                                                      nonSynonyms_FR = c())
...
for(k in 1:length(patient.dirs))
{
  ...
  allIsotypeDetails[["IGHG"]] <- data.frame(Synonymus =c(),nonSynonymus =c(),depth = c(),Ratio = c(),
                                            synonyms_CDR= c(),synonyms_FR = c(),nonSynonyms_CDR = c(),
                                            nonSynonyms_FR = c())
  ...
  allIsotypeDetails[["naive_IGHD"]] <- data.frame(Synonymus =c(),nonSynonymus =c(),depth = c(),Ratio = c(),
                                                  synonyms_CDR= c(),synonyms_FR = c(),nonSynonyms_CDR = c(),
                                                  nonSynonyms_FR = c())
...
names(TOTAL.allIsotypeDetails[["IGHG"]])<- c ("Synonymus","nonSynonymus","depth","Ratio",
                                                 "synonyms_CDR","synonyms_FR" ,"nonSynonyms_CDR",
                                                 "nonSynonyms_FR")
...
write.csv(TOTAL.allIsotypeDetails[["IGHA"]],file = "PFIZER_event_IGHA.csv")
write.csv(TOTAL.allIsotypeDetails[["IGHG"]],file = "PFIZER_event_IGHG.csv")
write.csv(TOTAL.allIsotypeDetails[["IGHM"]],file = "PFIZER_event_IGHM.csv")
write.csv(TOTAL.allIsotypeDetails[["naive_IGHM"]],file = "PFIZER_event_naive_IGHM.csv")

#write.csv(TOTAL.allIsotypeDetails[["IGHA"]],file = "PFIZER_event_ALL_IGHA.csv")
#write.csv(TOTAL.allIsotypeDetails[["IGHG"]],file = "PFIZER_event_ALL_IGHG.csv")
#write.csv(TOTAL.allIsotypeDetails[["IGHM"]],file = "PFIZER_event_ALL_IGHM.csv")
#write.csv(TOTAL.allIsotypeDetails[["naive_IGHM"]],file = "PFIZER_event_ALL_naive_IGHM.csv")

# if the script run on NOCDR3 mut mode
#write.csv(TOTAL.allIsotypeDetails[["IGHA"]],file = "PFIZER_event_IGHA_NoCDR3.csv")
#write.csv(TOTAL.allIsotypeDetails[["IGHG"]],file = "PFIZER_event_IGHG_NoCDR3.csv")
#write.csv(TOTAL.allIsotypeDetails[["IGHM"]],file = "PFIZER_event_IGHM_NoCDR3.csv")
#write.csv(TOTAL.allIsotypeDetails[["naive_IGHM"]],file = "PFIZER_event_naive_IGHM_NoCDR3.csv")
