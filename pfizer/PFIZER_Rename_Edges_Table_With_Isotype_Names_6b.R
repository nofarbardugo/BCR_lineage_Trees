    ...
    if(file.exists(filePath))
    {
      ...
      if(!is.null(edges.df))
      {
        ...
        #  {      
          ...
          pdf(paper = "a4",file =paste0("/home/bardugn1/pfizer/Plot/",dirs[i],"_",j,"_treeImage.pdf"),onefile = T)
         # pdf(paper = "a4",file =paste0("/home/bardugn1/pfizer/PlotNew/",patient.dirs[k],'/',dirs[i],"_",j,"_treeImage.pdf"),onefile = T)
        #   jpeg(filename=  paste0("/home/bardugn1/pfizer/PlotNew/",patient.dirs[k],'/',dirs[i],"_",j,"_treeImage.jpeg"),width = 1500, height = 900)
