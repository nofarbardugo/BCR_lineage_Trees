...
names(df.allIsotypeDetails)<- c("Edge Name","Synonymus","nonSynonymus","depth","Ratio", "synonyms_CDR","synonyms_FR",
                                  "nonSynonyms_CDR","nonSynonyms_FR")


write.csv(df.allIsotypeDetails,file = "SPLEEN_SPL_Edges_mutation_num_per_edge.csv")