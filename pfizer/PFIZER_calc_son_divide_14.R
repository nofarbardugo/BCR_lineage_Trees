...
df.allIsotypeDetails <- data.frame(IsotypeName = c(), SonNumber =c(),sonLikeFather =c(),sonDiffrente =c(),depth = c())
...
write.csv(df.allIsotypeDetails,file = "PFIZER_Node_son_divide.csv")
