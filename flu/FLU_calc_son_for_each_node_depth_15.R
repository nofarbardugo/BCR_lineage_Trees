...
#write.csv(df.allIsotypeDetails,file = "FLU_Node_son_divide_per_isotype.csv")
write.csv(df.allIsotypeDetails,file = "FLU_preVacine_Node_son_divide_per_isotype.csv")
#write.csv(df.allIsotypeDetails,file = "FLU_postVacine_Node_son_divide_per_isotype.csv")
