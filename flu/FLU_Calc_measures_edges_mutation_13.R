  ...
  # Returns: sutable edge name 
{
  ...
  return(switch(combine,
                "IGHG-1IGHG-1"= "G1-G1" , "IGHAIGHA"= "A-A","IGHEIGHE" ="E-E","IGHMIGHM"="M-M",
                "IGHDIGHD" = "ND-ND", "IGHG-2IGHG-2" ="G2-G2",
                "IGHMIGHD" = "M-ND","IGHDIGHG-1" = "ND-G1","IGHDIGHG-2" = "ND-G2","IGHDIGHA" = "ND-A","IGHDIGHE" = "ND-E",
                "IGHMIGHG-2" = "M-G2","IGHG-1IGHG-2" = "G1-G2", "IGHG-2IGHA" = "G2-A","IGHG-2IGHE" = "G2-E",
                "IGHMIGHG-1" = "M-G1","IGHMIGHA" = "M-A", "IGHMIGHE" = "M-E", 
                "IGHG-1IGHA" ="G1-A","IGHG-1IGHE" ="G1-E"))
}
...
write.csv(df.allIsotypeDetails,file = "FLU_Edges_mutation_num_per_edge.csv")
